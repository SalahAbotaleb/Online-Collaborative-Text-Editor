...
export default function DocumentPill({file, files, setFiles}) {
    ...
    >
        ...
        >
            ...
            >
                <Menu.Items
                    className="absolute font-['Product_sans'] right-0 z-10 mt-2 w-56 p-2 text-left origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                        <Menu.Item>
                            <div
